...
ggsave("plots/rateByPreType.png",       plot=rateByPreType)
ggsave("plots/rateByAftType.png",       plot=rateByAftType)
ggsave("plots/rateByPreAndAftType.png", plot=rateByPreAndAftType)
ggsave("plots/barbRateVsAll.png",       plot=barbRateVsAll)
ggsave("plots/barbRateVsTime.png",      plot=barbRateVsTime)
```